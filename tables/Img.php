...
if($res){
    ...
    while($show = mysqli_fetch_array($res)){
        ...
        imagestring($im, 500, 5, 5, "Zona: ".$show['Zona']." Fecha de carga: ".$show['FechaC']." Hora de carga: ".$show['HoraC']." Fecha de entrega: ".$show['FechaE']." Hora de entrega: ".$show['HoraE']." Direccion de entrega: ".$show['DireccionE']." Datos de contacto: ".$show['DatosC']." Factura: ".$show['Factura'] , $color_texto);
        imagepng($im);
        imagedestroy($im);
    }
